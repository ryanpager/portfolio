  ...
  return (
    <div className="flex-col space-y-8 lg:space-y-16">
      ...
      <div className="flex-col text-center">
        <h1 className="text-2xl lg:text-4xl text-slate-900 font-bold">
      ...
      <div className="text-center space-y-4 mx-auto">
        ...
        <ol className="text-sm text-slate-600 text-justify list-decimal pl-8 space-y-4 leading-6 lg:leading-8">
          <li>
      ...
      {/* Section - Setup */}
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Setting Everything Up</h2>
        <p className="text-sm text-slate-600 text-justify leading-6 lg:leading-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:pt-6">
          <div className="flex-col text-sm text-center">
            <p className="font-semibold text-slate-700">AngularJS</p>
            <Link
              className="text-xs text-slate-500 hover:font-semibold hover:text-purple-700 transition-all"
          ...
          <div className="flex-col text-sm text-center">
            <p className="font-semibold text-slate-700">ngMaterial</p>
            <Link
              className="text-xs text-slate-500 hover:font-semibold hover:text-purple-700 transition-all"
              href="https://angularjs.org/" 
              target="_blank">
          ...
          <div className="flex-col text-sm text-center">
            <p className="font-semibold text-slate-700">Ionic Framework</p>
            <Link
              className="text-xs text-slate-500 hover:font-semibold hover:text-purple-700 transition-all"
              href="https://angularjs.org/" 
              target="_blank">
      ...
      {/* Section - Diving In */}
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Diving In</h2>
        <p className="text-sm text-slate-600 text-justify leading-6 lg:leading-8">
      ...
      {/* Section - Code */}
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Example Code</h2>
      ...
      {/* Section - Code */}
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Implementation Code</h2>
      ...
      {/* Section - Code */}
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Usage</h2>
      ...
      <div className="text-center space-y-4 mx-auto">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">Extending for Custom Components</h2>
        <p className="text-sm text-slate-600 text-justify leading-6 lg:leading-8">
