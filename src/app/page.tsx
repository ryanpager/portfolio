...
export default function Home() {
  return (
    <div className="flex-col space-y-16">
      ...
      {/* Section - About Me */}
      <div className="flex-col mx-auto space-y-4">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">A Little Bit About Me</h2>
        <p className="text-justify text-sm text-slate-600 leading-6 lg:leading-8">
        ...
        <ul className="text-sm text-slate-600 text-justify list-disc lg:pl-8 space-y-4 leading-6 lg:leading-8">
          <li>
      ...
      <div className="flex-col mx-auto space-y-4">
        <h2 className="lg:text-xl text-slate-700 font-bold text-center">What is Otternaut?</h2>
        <p className="text-justify text-sm text-slate-600 leading-6 lg:leading-8">
