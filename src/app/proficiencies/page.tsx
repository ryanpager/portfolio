...
export default function Proficiencies() {
  return (
    <div className="flex-col space-y-16">
      ...
      <div className="text-center">
        <h2 className="lg:text-xl text-slate-600 font-bold text-center">Cloud & DevOps</h2>
        <p className="mx-auto text-sm text-slate-500 text-justify lg:max-w-prose lg:text-centerr leading-6 lg:leading-8 mt-4">
      ...
      {/* Languages - Proficiencies Grid */}
      <div className="text-center">
        <h2 className="lg:text-xl text-slate-600 font-bold text-center">Data Storage</h2>
        <p className="mx-auto text-sm text-slate-500 text-justify lg:max-w-prose lg:text-center leading-6 lg:leading-8 mt-4">
      ...
      <div className="text-center">
        <h2 className="lg:text-xl text-slate-600 font-bold text-center">Frameworks</h2>
        <p className="mx-auto text-sm text-slate-500 text-justify lg:max-w-prose lg:text-center leading-6 lg:leading-8 mt-4">
      ...
      <div className="text-center">
        <h2 className="lg:text-xl text-slate-600 font-bold text-center">Project Management & Tools</h2>
        <p className="mx-auto text-sm text-slate-500 text-justify lg:max-w-prose lg:text-center leading-6 lg:leading-8 mt-4">
